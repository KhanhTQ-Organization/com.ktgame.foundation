...
namespace com.ktgame.foundation.utils
{
	using System;
	...
	/// </summary>
	[Serializable]
	public abstract class SerializableDictionary_Base<TKey, TValue, TValueCache> : SerializableDictionary_Base, IDictionary<TKey, TValue>,
...
#region ISerializable
		...
		where TValueCache : SerializableDictionary.Cache<TValue>, new()
	{
		...
		protected SerializableDictionary(SerializationInfo serializationInfo, StreamingContext streamingContext) : base(serializationInfo,
			streamingContext) { }
